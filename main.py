...
while True:
    ...
    cv.circle(frame, (center_x, center_y), 3, (0, 255, 0))
    ...
    for face in faces:
        ...
        cv.putText(frame, f'Razvan',org, cv.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 2)
    ...
    #cv.putText(frame, f'Detectare faciala',(center_y, center_x), cv.FONT_HERSHEY_SIMPLEX, 2, (255, 0, 255), 2)
    adjust_tello_position(offset_x, offset_y, z_area)


    # Display the resulting frame
    cv.imshow('Tello Fereastra', frame)
